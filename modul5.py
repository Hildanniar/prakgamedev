...
#untuk mengatur Pandle di ball nya saat memantul
...
# Property ada widhtm height yang di satukan menjadi screen 
screen_width = 720
screen_height = 480
...
basic_font = pygame.font.Font('freesansbold.ttf', 32) #untuk merubah Jenis font
plob_sound = pygame.mixer.Sound("pong.ogg") #untuk menambahkan sound ketika bola memantul
score_sound = pygame.mixer.Sound("score.ogg") # untuk ketika permainan berhenti atau bola loss
middle_strip = pygame.Rect(screen_width/2 - 2,0,4,screen_height)

# Objek Game
player = Player('Paddle.png',screen_width - 20,screen_height/2,5) #menambahkan object paddle png
opponent = Opponent('Paddle.png',20,screen_width/2,5)#menambahkan object paddle png
...
#part ini untuk mengatur keyboard agar berfungsi untuk melakukan gerakan pada game menggunakan UP, DOWN, UP, DOWN
while True:
	...
	screen.fill(bg_color) #Membuat Latar Belakang
	pygame.draw.rect(screen,accent_color,middle_strip)#Menggambar Rect dengan Screen  Width dan height dan Midle String
	
	game_manager.run_game() # Untuk menjalankan game

	pygame.display.flip()	# Rendering
	clock.tick(120)
